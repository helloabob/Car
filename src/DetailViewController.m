...
//    p_panel.backgroundColor=[UIColor lightGrayColor];
    ...
    UITextField *txt=[[[UITextField alloc]initWithFrame:CGRectMake(20, 20, 280, 30)]autorelease];
    ...
    lbl.backgroundColor=[UIColor lightGrayColor];
    lbl.text=@"加密方式:";
    txt=[[[UITextField alloc]initWithFrame:CGRectMake(20, 58, 280, 30)]autorelease];
    txt.backgroundColor=[UIColor whiteColor];
    ...
    txt.textAlignment=NSTextAlignmentCenter;
    txt.delegate=self;
    UIButton *btn=[[[UIButton alloc]initWithFrame:CGRectMake(0, 0, 280, 30)]autorelease];
    ...
    lbl.backgroundColor=[UIColor lightGrayColor];
    lbl.text=@"身份验证:";
    txt=[[[UITextField alloc]initWithFrame:CGRectMake(20, 96, 280, 30)]autorelease];
    txt.backgroundColor=[UIColor whiteColor];
    ...
    txt.textAlignment=NSTextAlignmentCenter;
    txt.delegate=self;
    btn=[[[UIButton alloc]initWithFrame:CGRectMake(0, 0, 280, 30)]autorelease];
    ...
    lbl.backgroundColor=[UIColor lightGrayColor];
    lbl.text=@"网络密码:";
    txt=[[[UITextField alloc]initWithFrame:CGRectMake(20, 134, 280, 30)]autorelease];
    txt.backgroundColor=[UIColor whiteColor];
    ...
    [p_panel addSubview:txt];
    p_pwd=txt;
    btn = [[[UIButton alloc] initWithFrame:CGRectMake(40, 190, 220, 40)] autorelease];
